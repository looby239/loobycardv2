...
export function buildTemplateTestCard(
  ...
  return {
    ...
    bride_role: 'Cô dâu',
    groom_role: 'Chú rể',
    bride_father_name: isBasic ? null : 'Ông Nguyễn Văn Minh',
    bride_mother_name: isBasic ? null : 'Bà Trần Thị Mai',
    groom_father_name: isBasic ? null : 'Ông Lê Văn Kiệt',
    groom_mother_name: isBasic ? null : 'Bà Phạm Thị Hoa',
    bride_address: isBasic ? null : 'Gia đình nhà gái, TP. Hồ Chí Minh',
    groom_address: isBasic ? null : 'Gia đình nhà trai, TP. Hồ Chí Minh',

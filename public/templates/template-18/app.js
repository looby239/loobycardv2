document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- Falling Red Petals Particles Generator ---
  ...
  if (particlesContainer) {
    ...
    for (let i = 0; i < maxParticles; i++) {
      ...
      const redShades = ['#D25F65', '#b54b51', '#f5c4c8', '#ff6b6b', '#9e1b1b'];
  ...
  const STORAGE_KEY = 'looby_wedding_wishes_18';

  // Fallback default wishes
  const defaultWishes = [
    { name: 'Khánh Linh', text: 'Chúc mừng hạnh phúc anh Lộc và chị Thư! Chúc hai anh chị trăm năm hạnh phúc, răng long đầu bạc.' },
    { name: 'Anh Quân', text: 'Mẫu thiệp Vườn Xuân Đỏ này ấm cúng quá. Chúc hai bạn luôn tràn ngập tiếng cười và hạnh phúc bên tổ ấm mới!' }
  ];
  ...
  function showCustomAlert(message, title = 'Thông Báo') {
    ...
    alertBtn.style.cssText = `
      ...
      font-weight: 600;
      cursor: pointer;
      box-shadow: 0 4px 10px rgba(158, 27, 27, 0.25);

...
export default function Template18({ card, previewMode = false }: TemplateProps) {
  ...
  const eventDateObj = card.event_date ? new Date(card.event_date) : new Date('2026-06-21');
  ...
  const partyTime = card.ceremony_time || '11:30';
  ...
  const coverImage = card.cover_image_url || '/assets/images/template-18/photo1.jpg';
  const albumImages = card.album_images && card.album_images.length > 0 ? card.album_images : [
    ...
    '/assets/images/template-18/photo5.jpg',
  ];
  ...
  return (
    <div className="t18-wrapper">
      ...
      <div className={`envelope-overlay ${opened ? 'open' : ''}`} id="envelope-overlay">
        ...
        <div className="envelope-card">
          ...
          <div className="envelope-inner">
            {/* Corner floral assets */}
            <img src="/assets/images/template-18/asset_1.webp" className="decor top-right" alt="" />
            <img src="/assets/images/template-18/asset_2.webp" className="decor bottom-left" alt="" />
      ...
      <div className="template-container" id="main-container" style={{ display: opened ? 'block' : 'none' }}>
        ...
        <img src="/assets/images/template-18/asset_1.webp" className="bg-decor-top" alt="" />
        <img src="/assets/images/template-18/asset_2.webp" className="bg-decor-bottom" alt="" />
        ...
        <header className="wedding-header">
          <div className="hero-frame-container">
            <div className="hero-frame">
              ...
              <div className="polaroid-text">{card.bride_name} &amp; {card.groom_name}</div>
            </div>
          </div>
